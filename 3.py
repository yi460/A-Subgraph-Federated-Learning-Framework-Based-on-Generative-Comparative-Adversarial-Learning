...
def visualize_results(dist_matrix, ours_metrics, fedavg_acc, last_protos, dataset_name):
    ...
    ref_vals = {
        ...
        'PubMed': [84.1, 84.5, 84.9, final_acc_ours],
        'Cora': [71.0, 83.5, 84.8, max(85.2, final_acc_ours)],
        'Citeseer': [67.0, 71.8, 73.0, max(73.5, final_acc_ours)],
    }

    vals = ref_vals.get(dataset_name, [0, 0, 0, final_acc_ours])
    ...
    ax5.set_ylim(min_val - 2, max(vals) + 2)
